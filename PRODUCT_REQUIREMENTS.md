...
### 1.1 背景与痛点
在信息碎片化时代，知识工作者面临两大挑战：**难以保持长时间的深度专注**以及**阅读过的知识缺乏有效回顾机制**。ReadFocus 旨在连接“工作流”与“知识流”，利用番茄工作法（Pomodoro）的休息间隙，主动推送用户个人的阅读笔记，实现“专注即复习”。

### 1.2 核心价值
- **专注激励**：将“阅读回顾”作为专注完成后的精神奖励。
- **知识激活**：唤醒沉睡在微信读书里的高亮笔记，促进知识内化。
- **隐私安全**：坚持“本地优先（Local-First）”原则，个人数据绝不上传云端。

### 1.3 目标用户
- **深度阅读者**：在微信读书积累了大量划线的用户。
- **效率追求者**：习惯使用番茄钟或专注工具的学生及职场人士。
