...
| 编号 | 功能点 | 优先级 | 描述 |
| :--- | :--- | :--- | :--- |
| R01 | 随机算法 | P0 | **加权随机**：优先推荐划线多的书；**自定义置顶**：用户指定书籍权重放大100倍；**黑名单**：屏蔽《房思琪》等书籍。**严格过滤：仅Type=1划线**。 |
| R03 | 全量同步 | P0 | **新增**：支持一键下载所有划线笔记至本地。**自动适配：本地开发环境（CookieCloud/Env）可免手动输入 Cookie 直接同步。** |
| R02 | 兜底机制 | P1 | 若随机抽样失效，自动尝试**Top 5**笔记最多的书（不再单一锁定Top 1），直至找到有内容的书籍。 |
...
| 编号 | 功能点 | 优先级 | 描述 |
| :--- | :--- | :--- | :--- |
| **S01** | **数据纯净性** | **P0** | **严禁展示非用户本人的内容**。移除所有“热门划线”兜底逻辑，确保展示内容100%来自用户个人笔记。 |
